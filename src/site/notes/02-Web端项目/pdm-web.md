---
{"dg-publish":true,"permalink":"/02-web/pdm-web/","dg-note-properties":{"cssclasses":["wiki-page","wiki-project"]}}
---
...
> [!abstract] 项目定位
> 产品信息库管理后台，管理产品详情、SPU / SKU、变更记录与附件。

> [!wiki-nav] 本页导航
> [[02-Web端项目/pdm-web#快速启动\|启动]] · [[02-Web端项目/pdm-web#项目结构\|目录]] · [[02-Web端项目/pdm-web#核心功能模块\|业务模块]] · [[02-Web端项目/pdm-web#环境配置\|环境]] · [[02-Web端项目/pdm-web#配置说明\|配置]]
...
[[01-导航与索引/项目总览#技术栈\|技术栈]] · [[09-问题与记录/问题记录\|问题记录]] · [[01-导航与索引/项目维护#剑南春项目系列\|剑南春项目系列]]
