---
{"dg-publish":true,"permalink":"/03/wechat-test/","dg-note-properties":{}}
---

# wechatTest

> 基于微信 Minium / `minitest` 的小程序自动化测试项目，支持 dev、uat、prod 多环境运行，并可自动生成和托管测试报告。
...
测试完成后，启动器会检查本机 `9525` 端口，并在需要时用 Python HTTP Server 托管 `outputs/` 报告目录。
