---
{"dg-publish":true,"dg-permalink":"live-push-api","permalink":"/live-push-api/","dg-note-properties":{"permalink":"/live-push-api/","cssclasses":["wiki-page","wiki-article"]}}
---


[[index\|首页]] / [[07-运维与发布/专项/直播审核知识地图\|直播审核]] / 推送任务 API

# 直播推送任务API文档

按任务类型查找推送接口，再选择 UAT 或生产环境的示例。本文保留接口地址和参数记录；客户端收到任务后的链路见 [[07-运维与发布/专项/直播审核知识地图\|直播审核知识地图]]。

> [!wiki-nav] 本页导航
> [[07-运维与发布/专项/直播推送任务API文档#文档地址\|对接文档]] · [[07-运维与发布/专项/直播推送任务API文档#1. 推送直播任务\|直播任务]] · [[07-运维与发布/专项/直播推送任务API文档#2. 推送凭证任务\|凭证任务]] · [[07-运维与发布/专项/直播推送任务API文档#备注\|环境信息]]

## 文档地址

[直播审核系统对接文档](https://ea-dev.jncapp.cn/live-docs)

## 直连网站

[打开直播对接站点](https://live.ddom.qzz.io/)
